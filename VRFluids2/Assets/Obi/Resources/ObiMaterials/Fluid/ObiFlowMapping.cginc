...
void FlowmapAdvect_float(in float3 position, in float3 velocity, in float3 jump, in float speedScale, in float offset, in float time, out float3 flowUV1, out float3 flowUV2, out float2 weights)
{
    velocity *= speedScale;
    time /= speedScale;
