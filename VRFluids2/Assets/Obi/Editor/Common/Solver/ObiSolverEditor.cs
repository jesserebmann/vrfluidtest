...
namespace Obi
{
    ...
    public class ObiSolverEditor : Editor
    {
        ...
        SerializedProperty velocityRange;
        SerializedProperty vorticityRange;
        SerializedProperty foamGenerationRate;
        SerializedProperty foamDuration;
        ...
        public void OnEnable()
        {
            ...
            velocityRange = serializedObject.FindProperty("velocityRange");
            vorticityRange = serializedObject.FindProperty("vorticityRange");
            foamGenerationRate = serializedObject.FindProperty("foamGenerationRate");
            foamDuration = serializedObject.FindProperty("foamDuration");
        ...
        public override void OnInspectorGUI()
        {
            ...
            advectionFoldout.value = EditorGUILayout.BeginFoldoutHeaderGroup(advectionFoldout, "Advection settings");
            if (advectionFoldout)
            {
                ...
                EditorGUILayout.LabelField("Global foam potential", EditorStyles.boldLabel);
                EditorGUILayout.PropertyField(velocityRange);
                EditorGUILayout.PropertyField(vorticityRange);
                EditorGUILayout.PropertyField(foamGenerationRate);
                EditorGUILayout.PropertyField(foamDuration);
            }
            EditorGUILayout.EndFoldoutHeaderGroup();
