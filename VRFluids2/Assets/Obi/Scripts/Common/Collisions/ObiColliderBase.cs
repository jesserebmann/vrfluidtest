...
namespace Obi
{
    ...
    public abstract class ObiColliderBase : MonoBehaviour
    {
        ...
        protected ObiForceZone obiForceZone;
        ...
        public void FindForceZone()
        {
            obiForceZone = GetComponent<ObiForceZone>();
        }
        ...
        private void OnEnable()
        {
            ...
            // Find force zone component, if any:
            FindForceZone();
        }
