                    ...
                    solver.renderablePositionsBuffer.count > 0)
                {
                    ...
                    for (int i = 0; i < batchCount; ++i)
                    {
                        ...
                        using (m_ChunkMarker.Auto())
                        {
                            ...
                            chunkShader.SetBuffer(sortKernel, "sortedVelocities", solver.particleGrid.sortedFluidData);
                            ...
                            chunkShader.SetBuffer(sortKernel, "sortedColors", solver.particleGrid.sortedUserDataVelColor);
                        ...
                        using (m_SDFMarker.Auto())
                        {
                            ...
                            meshComputeShader.SetBuffer(sdfKernel, "sortedVelocities", solver.particleGrid.sortedFluidData);
                            ...
                            meshComputeShader.SetBuffer(sdfKernel, "sortedColors", solver.particleGrid.sortedUserDataVelColor);
                        ...
                        rp.matProps.SetFloat("_Refraction", batch.renderPass.refractionIntensity);
