    ...
    public class ComputeDensityConstraintsBatch : ComputeConstraintsBatchImpl, IDensityConstraintsBatchImpl
    {
        ...
        public override void Evaluate(float stepTime, float substepTime, int steps, float timeLeft)
        {
            if (solverImplementation.particleGrid.sortedFluidIndices != null && solverImplementation.cellCoordsBuffer != null)
            {
                ...
                shader.SetBuffer(densitiesKernel, "renderableOrientations", solverImplementation.renderableOrientationsBuffer);
        ...
        public override void Apply(float substepTime)
        {
            if (solverImplementation.particleGrid.sortedFluidIndices != null && solverImplementation.cellCoordsBuffer != null)
            {
                ...
                shader.SetBuffer(applyKernel, "renderableOrientations", solverImplementation.renderableOrientationsBuffer);
                ...
                shader.SetBuffer(applyKernel, "anisotropies", solverImplementation.anisotropiesBuffer);
                ...
                shader.SetBuffer(applyPositionDeltaKernel, "renderableOrientations", solverImplementation.renderableOrientationsBuffer);
